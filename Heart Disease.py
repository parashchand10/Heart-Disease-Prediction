...
if submit:
    with st.spinner("Analyzing data..."):
        ...
        if prediction[0] == 1:
            ...
            st.write("Recommendation: Please consult with a healthcare professional for a detailed evaluation.")
        else:
            st.success("### Result: No Heart Disease Detected")
            st.write("Note: This is a screening tool. Always prioritize professional medical advice.")
